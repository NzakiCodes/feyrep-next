...
export default function About() {
    return (
        <Layout pageTitle="About" style={{ backgroundColor: "#faf8eb" }}>
            <PagesHeader img="/images/sections/IMG-2244.jpg" />
            ...
            <Section fullWidth className="px-7 lg:px-20 bg-white">
                <Grid className="container grid-cols-1 lg:grid-cols-2">
                    ...
                    <div>
                        <img className="rounded-xl" src="/images/about/DSC_0230.jpg" alt="" />
                    </div>
                </Grid>
            </Section>
            ...
            <Section fullWidth className="px-7 lg:px-14 container">
                <Grid className="grid-cols-1 lg:grid-cols-2">
                    <div>
                        <img className="rounded-xl" src="/images/about/IMG_7613.jpg" alt="" />
                    </div>
            ...
            <Section fullWidth className="px-7 lg:px-20 bg-white">
                <Grid className="grid-cols-1 lg:grid-cols-2 container">
                    ...
                    <div>
                        <img className="rounded-xl" src="/images/DSC_0909.JPG" alt="" />
                    </div>
                </Grid>
            </Section>
            <Section fullWidth className="px-7 lg:px-14 container">
                <Grid className="grid-cols-1 lg:grid-cols-2">
                    <div>
                        <img className="rounded-xl" src="/images/sections/children-3319460_1920.jpg" alt="" />
                    </div>
            ...
            <Section fullWidth className="px-12 lg:px-20 bg-white">
                <Grid className="grid-cols-1 lg:grid-cols-2 container">
                    ...
                    <div>
                        <img className="rounded-xl" src="/images/about/IMG_2896.jpg" alt="" />
                    </div>
                </Grid>
            </Section>
            <Section fullWidth className="px-7 lg:px-14 container">
                <Grid className="grid-cols-1 lg:grid-cols-2">
                    <div>
                        <img className="rounded-xl" src="/images/about/students.jpeg" alt="" />
                    </div>
                    <div className="text-primary lg:px-14 px-6 mt-6 lg:mt-0">
                        <div className="my-1 ">
