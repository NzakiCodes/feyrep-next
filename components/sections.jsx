...
export const SectionTitle = ({title,subtitle}) => (
    <div className="text-center  mb-7">
        <div className="title pb-3 lg:py-10">
            <h2 className="text-xl  lg:text-lg uppercase font-bitter font-extrabold mb-4 text-primary-600">{title}</h2>
            <h3 className="text-3xl lg:text-5xl font-bitter capitalize font-extrabold">{subtitle}</h3>
        </div>
    </div>
)
