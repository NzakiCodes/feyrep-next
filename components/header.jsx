        ...
        <div className="absolute inset-0 w-full h-full object-cover object-center z-30 bg-opacity-80 bg-black ">
            <div className="flex justify-center">
                <div className=" md:container m-auto max-h-11 py-10 md:mt-20 text-center">
                    ...
                    <h2 className="md:text-7xl text-secondary text-6xl m-10 text-center  font-storytella ">
                        In the Society.
                    </h2>
                    ...
                    <div className="my-12">
                        <a href="/about" className="btn  mt-9 px-12 rounded-full border-primary-200  hover:bg-primary-200 border-2 tracking-wider font-quicksand hover:text-white ">Know More</a>
                    </div>
